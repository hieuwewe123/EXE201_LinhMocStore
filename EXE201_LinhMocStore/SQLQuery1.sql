...
CREATE TABLE Cart ( CartID INT PRIMARY KEY IDENTITY(1,1), UserID INT FOREIGN KEY REFERENCES [User](UserID), CreatedAt DATETIME NOT NULL DEFAULT GETDATE() );
...
CREATE TABLE OrderDetails ( OrderDetailID INT PRIMARY KEY IDENTITY(1,1), OrderID INT FOREIGN KEY REFERENCES [Order](OrderID), ProductID INT FOREIGN KEY REFERENCES Product(ProductID), Quantity INT NOT NULL, Price DECIMAL(10, 2) NOT NULL );
-- Tạo bảng Payment 
...
CREATE TABLE Notification ( NotificationID INT PRIMARY KEY IDENTITY(1,1), UserID INT FOREIGN KEY REFERENCES [User](UserID), Content NVARCHAR(500), Status NVARCHAR(20), CreatedAt DATETIME );
-- Tạo bảng Blog 
CREATE TABLE Blog (
...
(N'Vòng trầm hương 54 hạt', 50000, 15, N'Vòng tay trầm hương tự nhiên 54 hạt, mang lại bình an', N'Trầm hương', N'6mm', N'https://pos.nvncdn.com/877529-112891/ps/20220809_eDxSCdVsBejYmeqQkWxz1Ko6.jpg', 1),
(N'Vòng trầm hương mix charm vàng', 125000, 5, N'Vòng tay trầm hương kết hợp charm vàng 18K', N'Trầm hương', N'8mm', N'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTGHXv5kNzsAM5z4yWYlS3xA9s3CL-rR4J7_g&s', 1),
(N'Vòng gỗ sưa trắng 10mm', 150000, 12, N'Vòng tay gỗ sưa trắng tự nhiên, cao cấp', N'Gỗ sưa', N'10mm', N'https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcTGETYGkFDWC3wlvm63InX1jUQ8fARGnyjrIbtQ55hYdf8GJPi49DIOqfYhPL3kls6p4sW7RuwEmGFs2K-Hm3l6Ai_p_Gh29w6LluaMgKY0WTG2pOBny6sacw', 2),
(N'Vòng gỗ sưa đỏ 8mm', 120000, 10, N'Vòng tay gỗ sưa đỏ phong thủy, năng lượng mạnh', N'Gỗ sưa', N'8mm', N'https://gosuado.com/Pictures/trang-hat-go-sua2.jpg', 2),
(N'Vòng gỗ sưa mix đá quý', 175000, 6, N'Vòng tay gỗ sưa kết hợp đá quý tự nhiên', N'Gỗ sưa', N'12mm', N'https://henryjewels.com/wp-content/uploads/2024/09/vong-sua-do-quang-binh-mix-charm-cam-thach-2.jpg', 2),
(N'Vòng huyết long 8mm', 50000, 20, N'Vòng tay gỗ huyết long tự nhiên, hợp mệnh Hỏa', N'Huyết long', N'8mm', N'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQcgqhXgCiob2HBy8cGBSVnjQzSx741ckm-3g&s', 3),
(N'Vòng huyết long 12mm', 60000, 10, N'Vòng tay gỗ huyết long cao cấp, năng lượng mạnh', N'Huyết long', N'12mm', N'https://down-vn.img.susercontent.com/file/9558d9bb95611e5be41f4f4927294abe', 3),
(N'Vòng trầm hương cao cấp 10mm', 70000, 7, N'Vòng tay trầm hương chất lượng cao, mùi thơm dịu', N'Trầm hương', N'10mm', N'https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcQgNZxQTTAuk-93o-lyULZjiOSelaDNThFKiBghB-4oO1BljngEiVLNa439o2Ng785O5yBNkjhhhIyzXzrFWXYvKVSMSCYKCDWVhv6MfQ5Lts5CdWoD2Vd2&usqp=CAc', 1),
(N'Vòng gỗ sưa khắc rồng', 165000, 4, N'Vòng tay gỗ sưa khắc hình rồng phong thủy', N'Gỗ sưa', N'14mm', N'https://down-vn.img.susercontent.com/file/cn-11134207-7r98o-lqyd7io0cazx4c.webp', 2),
(N'Vòng huyết long mix bạc', 150000, 8, N'Vòng tay gỗ huyết long kết hợp charm bạc', N'Huyết long', N'10mm', N'https://vonghuyetlong.com/wp-content/uploads/2024/04/Vong-huyet-long-10ly-mix-ty-huu-bac-1.jpg', 3),
(N'Vòng trầm hương 6mm', 60000, 18, N'Vòng tay trầm hương nhỏ gọn, phù hợp mọi lứa tuổi', N'Trầm hương', N'6mm', N'https://i1.wp.com/viethuongtram.vn/wp-content/uploads/2018/04/vong-tram-sanh-chim-108-hat-1.jpg?fit=2048%2C1262&ssl=1', 1),
(N'Vòng gỗ sưa 16mm', 140000, 5, N'Vòng tay gỗ sưa kích thước lớn, mạnh mẽ', N'Gỗ sưa', N'16mm', N'https://gosuado.com/Pictures/vong-tay-go-sua-gia-16mm.jpg', 2),
(N'Vòng huyết long 6mm', 45000, 15, N'Vòng tay gỗ huyết long nhỏ gọn, hợp mệnh Thổ', N'Huyết long', N'6mm', N'https://henryjewels.com/wp-content/uploads/2025/01/vong-huyet-long-thau-quang-6mm-108-ava.jpg', 3),
(N'Vòng trầm hương mix đá thạch anh', 160000, 6, N'Vòng tay trầm hương kết hợp đá thạch anh tím', N'Trầm hương', N'8mm', N'https://product.hstatic.net/1000069526/product/thach-anh-mat-ho-thien-nhien-khac-chu-ommanib_0a7cedf4fbaa4798b5d006f3fc5c4334_master.jpg', 1);

INSERT INTO Cart (UserID) VALUES (2);
-- CartItem
INSERT INTO CartItem (CartID, ProductID, Quantity) VALUES (1, 1, 1), (1, 3, 2);
-- Order 
INSERT INTO [Order] (UserID, OrderDate, Status, TotalAmount, CreatedAt, ReceiverName, ReceiverPhone, ShippingAddress, DeliveryNote) VALUES 
(2, GETDATE(), N'Đã thanh toán', 300000, GETDATE(), N'Nguyễn Văn A', N'0912345678', N'456 Đường B, Phường 1, Quận 2, TP.HCM', N'Giao hàng trong giờ hành chính');
-- OrderDetails
INSERT INTO OrderDetails (OrderID, ProductID, Quantity, Price) VALUES (1, 1, 1, 50000), (1, 3, 2, 250000);
-- Payment
INSERT INTO Payment (OrderID, Content, Price, TransactionCode, Status, isCompleted, CreatedAt) VALUES (1, N'Thanh toán đơn hàng #1', 300000, N'TRANS001', N'Thành công', 1, GETDATE());
-- Notification
